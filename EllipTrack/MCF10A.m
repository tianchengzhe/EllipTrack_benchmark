...
%   i-th segment.
image_path = {'Z:/projects/tracking_code/20181115/Raw/'};
...
bias_paths = {'Z:/microscope_mat_files/nikon1_matfiles/CFP.mat';
    'Z:/microscope_mat_files/nikon1_matfiles/mCherry.mat'};
...
wells_to_track = [2, 1, 1];

% frames_to_track: Frame IDs.
frames_to_track = 1:288;
...
training_data_path = {'Z:/projects/tracking_code/submission2/my_MCF10A/elliptrack/density_withpost/training_data/training_data_21_100.mat';
    'Z:/projects/tracking_code/submission2/my_MCF10A/elliptrack/density_withpost/training_data/training_data_126_175.mat';
    'Z:/projects/tracking_code/submission2/my_MCF10A/elliptrack/density_withpost/training_data/training_data_201_250.mat'};

% output_path: Path to the folder storing the output MAT files.
output_path = 'Z:/projects/tracking_code/submission2/my_MCF10A/elliptrack/density_withpost/results/';
...
mask_path = 'Z:/projects/tracking_code/submission2/my_MCF10A/elliptrack/density_withpost/mask/';
...
%   Use empty character ('') if not generating this output.
%   Suggested for evaluating the accuracy of segmentation.
ellipse_movie_path = 'Z:/projects/tracking_code/submission2/my_MCF10A/elliptrack/density_withpost/ellipse_movie/';
...
seg_info_path = 'Z:/projects/tracking_code/submission2/my_MCF10A/elliptrack/density_withpost/seg_info/';
...
vistrack_path = 'Z:/projects/tracking_code/submission2/my_MCF10A/elliptrack/density_withpost/vistrack/';
