...
%   i-th segment.
image_path = {'Z:/projects/tracking_code/submission2/Cappell_BJ5TA/Raw/'};
...
wells_to_track = allcomb(2:2, 1:1, 4:4);

% frames_to_track: Frame IDs.
frames_to_track = 1:107;
...
training_data_path = {'Z:/projects/tracking_code/submission2/Cappell_BJ5TA/elliptrack/withpost/training_data/training_data_11_60.mat'};

% output_path: Path to the folder storing the output MAT files.
output_path = 'Z:/projects/tracking_code/submission2/Cappell_BJ5TA/elliptrack/withpost/results/';
...
mask_path = 'Z:/projects/tracking_code/submission2/Cappell_BJ5TA/elliptrack/withpost/mask/';
...
%   Use empty character ('') if not generating this output.
%   Suggested for evaluating the accuracy of segmentation.
ellipse_movie_path = 'Z:/projects/tracking_code/submission2/Cappell_BJ5TA/elliptrack/withpost/ellipse_movie/';
...
seg_info_path = 'Z:/projects/tracking_code/submission2/Cappell_BJ5TA/elliptrack/withpost/seg_info/';
...
vistrack_path = 'Z:/projects/tracking_code/submission2/Cappell_BJ5TA/elliptrack/withpost/vistrack/';
