...
channel_names = {'mIFP'};
ringcalc = 0;
num_frames = 482; % start from frame 1, until frame num_frames

addpath('Functions/');
image_dir = 'Z:/projects/tracking_code/submission2/my_A375/Raw/';

%% define mask directory, load cmos offset, define dir of bias
base_output_dir = 'Z:/projects/tracking_code/submission2/my_A375/mingyu/';
cmosoffset_dir = '';
bias_dir = '';
...
nucr = 16;  %nucr=6 for 10X and 2x2 bin
debrisarea = 100;
boulderarea = 1500;
blobthreshold = -0.03;
